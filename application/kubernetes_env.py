...
class KubernetesEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.MAX_PODS = 100
        self.MAX_CPU_PER_POD = 1600  # Adjust as needed
        self.MAX_MEM_PER_POD = 2048  # Adjust as needed
    ...
    def step(self, action):
        ...
        if action == 0:
            ...
            self.memory_per_pod = max(128, self.memory_per_pod / 2)
    ...
    def _simulate_environment(self):
        ...
        cpu_per_request = 0.02   # CPU units per request
        mem_per_request = 0.0256 # Memory units per request
        ...
        cpu_usage_per_pod = min(cpu_usage_per_pod, 100)

        mem_usage_per_pod = ((base_mem_consumption + mem_needed_per_pod) / self.memory_per_pod) * 100
        mem_usage_per_pod = min(mem_usage_per_pod, 100)
